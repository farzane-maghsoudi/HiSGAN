...
def parse_args():
    ...
    parser.add_argument('--print_freq', type=int, default=300000, help='The number of image print freq')
    ...
    parser.add_argument('--identity_weight', type=int, default=2, help='Weight for identity')
    parser.add_argument('--penalty_weight', type=int, default=0.1, help='Weight for penalty')
    parser.add_argument('--contrast_weight', type=int, default=5, help='Weight for contrast')
