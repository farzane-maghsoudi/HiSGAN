...
#     _,m1, s1 = _compute_statistics_of_path(paths[0], model, batch_size,
#                                          dims, cuda)
#     _,m2, s2 = _compute_statistics_of_path(paths[1], model, batch_size,
#                                          dims, cuda)
...
def calculate_given_paths(paths, batch_size, cuda, dims):
    ...
    ret = polynomial_mmd_averages(
            act1, act2, degree=args.mmd_degree, gamma=args.mmd_gamma,
